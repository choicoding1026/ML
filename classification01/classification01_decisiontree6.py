'''
    ...
    5. HyperParameter
        ...
        min_samples_split
        max_feature
        ==> HyperParameter를 활용하여 과적합(overfitting)을 방지할 수 있다.
            데이터 분류 예측을 일반화할 수 있다.
'''
...
# 3. 모델 생성 => decision tree(HyperParameter)
model = DecisionTreeClassifier(min_samples_split=4, random_state=14, criterion='entropy')
